...
class ElementAttributes extends BaseAttributes {
	 ...
	 *
	 * Supports standard HTML attributes, data-* / aria-* attributes,
	 * XML namespaced attributes (xml:lang), and JS framework directives
	 * such as Alpine.js (@click, x-on:keydown.enter, :class).
	 *
