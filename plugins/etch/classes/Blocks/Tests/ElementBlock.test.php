...
class ElementBlockTest extends WP_UnitTestCase {
	...
	/**
	 * Test element renders paragraph with a br tag inside
	 */
	public function test_element_renders_paragraph_with_br_tag() {
		$inner_blocks = array(
			array(
				'blockName'    => 'etch/text',
				'attrs'        => array( 'content' => 'First line' ),
				'innerBlocks'  => array(),
				'innerHTML'    => '',
				'innerContent' => array(),
			),
			...
			array(
				'blockName'    => 'etch/text',
				'attrs'        => array( 'content' => 'Second line' ),
				'innerBlocks'  => array(),
				'innerHTML'    => '',
				'innerContent' => array(),
			),
		...
		$this->assertEquals( '<p>First line<br />Second line</p>', $result );
	}

	/**
	 * Alpine.js / framework directive attributes
	 */
	public function test_element_renders_with_alpine_js_event_and_bind_attributes() {
		$result = $this->render_element(
			array(
				'tag'        => 'div',
				'attributes' => array(
		...
		$this->assertStringContainsString( '@click="open = !open"', $result );
		$this->assertStringContainsString( ':class="activeClass"', $result );
		$this->assertStringContainsString( 'x-show="open"', $result );
		$this->assertStringContainsString( 'x-on:click="submitForm()"', $result );
	}
}
